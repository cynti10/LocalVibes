...
function sendMessage() {
    ...
    userMessageElement.innerHTML = `${userMessage}<img src="https://static-00.iconduck.com/assets.00/user-icon-1024x1024-dtzturco.png" alt="user_img">`;
    ...
    .then(data => {
        ...
        botMessageElement.innerHTML = `<img src="https://upload.wikimedia.org/wikipedia/commons/0/0c/Chatbot_img.png" class="logo" alt="Bot Icon"> ${botResponse}`;
